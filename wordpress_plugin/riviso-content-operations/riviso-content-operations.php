            ...
            foreach ((array)$yoast_fields as $field) {
                register_post_meta($post_type, $field, [
                    ...
                    'auth_callback' => function () {
                        // Restrict read/write of meta over REST to authenticated users who can edit posts.
    ...
    public static function register_rest_routes() {
        register_rest_route(self::REST_NAMESPACE, '/ping', [
            ...
            'permission_callback' => function () {
                // Require standard WP REST authentication. Riviso uses WordPress Application Passwords.
                return current_user_can('edit_posts');
            },
