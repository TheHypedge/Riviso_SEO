...
_DEFAULT_WRITING_PROMPT_TEXT = (
    ...
    "- Never use a semicolon as a sentence connector. Use a full stop or comma instead.\n"
    "- Never use a colon as a dramatic mid-sentence pause. Write a complete sentence.\n\n"
    "SEO REQUIREMENTS\n"
...
def _require_project_access(*, st, user: dict, project_id: str) -> dict:
    # Prompts are a content operation — active project collaborators may manage them.
    # full=True: callers read/mutate proj["prompts"] / proj["default_prompt_id"],
