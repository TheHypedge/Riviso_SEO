...
_DEFAULT_WRITING_PROMPT_TEXT = (
    "Write a long, comprehensive, in-depth article for the given title and keywords. "
    "Aim for 1,500–2,500 words of substantive content.\n\n"
    "REQUIRED STRUCTURE:\n"
    "- Start with a compelling 2–3 sentence introduction that names the problem or situation directly\n"
    "- Divide the body into at least 4–5 main sections using ## H2 headings\n"
    ...
    "- Each main section needs at least 2–4 substantive paragraphs or equivalent structured content\n"
