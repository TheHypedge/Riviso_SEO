...
def build_generation_messages(
    *,
    ...
    depth_and_faq_blocks = "" if is_compiled else (
        ...
        "- Cover the topic fully: explain what it is, why it matters, how it works, common mistakes, and best practices — each as its own section.\n"
        ...
        "\n\nFAQ SECTION (apply unless the user's writing instructions specify otherwise):\n"
        "- Include a ## Frequently Asked Questions section near the end, placed before the conclusion.\n"
        "- This section is optimised for AI answer engines (Google AI Overview, Perplexity, ChatGPT) — write answers that can be cited directly.\n"
